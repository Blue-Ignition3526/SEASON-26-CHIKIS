...
public class FieldConstants {
    ...
    public static final Translation2d kBlueHubPosition = new Translation2d(4.62, 4.03);
    public static final Translation2d kRedHubPosition = new Translation2d(11.91, 4.03);
